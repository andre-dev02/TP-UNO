...
void jogar (pilha *baralho, pilha *mesa, Mao *jogador1, Mao *jogador2, int vez){
    ...
    for( ; ; ){ //for em loop
        if ( vez == 1) {
            ...
            if ( num == 77 || num == 82 || num == 84 || num == 66 || num == 43|| num < 10) {
                if ( cor == 5) {  //compra carta
                    pop(baralho,&_carta);
                    jogador1 = insere(jogador1, _carta);
                    vez++;
                } else {  
                    _carta.cor = cor;
                    _carta.numero = num;
                    jogador1 = retiracarta(jogador1,_carta,mesa,baralho,_carta.cor,_carta.numero); // tira a carta da mao do jogador
     ...
     /*------------------------------------------------------------------------------------------------*/
     //os comandos do jogador1 se repetem para o jagador2
        if ( vez == 2) {
            do {
            ...
            if ( num == 77 || num == 82 || num == 84 || num == 66 || num == 43|| num < 10) {
                if ( cor2 == 5) {
                    pop(baralho,&_carta);
                    jogador2 = insere(jogador2,_carta);
                    vez--;
                }
                else {
                    _carta.cor = cor2;
                    _carta.numero = num2;
                    jogador2 = retiracarta(jogador2,_carta,mesa,baralho,_carta.cor,_carta.numero);
